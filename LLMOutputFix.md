...
SEMANTIC_INTERPRETATIONS = {
    ...
    'speech_coverage': {
        ...
        'notes': 'Methodology: Data-driven (production patterns). Measures proportion of temporal window with speech. Production shows clear pattern: top performers avg 0.078-0.179 (minimal/low coverage) vs bottom avg 0.778-0.889 (high/constant coverage). Suggests breathing room, music, or silence correlates with better performance.'
    },
    ...
    'word_density_std': {
        ...
        'notes': 'Methodology: Data-driven (individual video distribution). Std deviation of word_count across temporal windows. Measures pacing consistency across video sections. Production shows top performers avg 0.389 vs bottom 1.873 (dataset averages include many silent videos). Individual video values range 0-25 based on real data. Lower std = more consistent pacing.'
    },
    ...
    'eye_contact_rate': {
        ...
        'notes': 'Methodology: Quartile-based. Measures proportion of window with eye contact (MediaPipe detection). Production shows mixed patterns: hook top=0.513 vs bottom=0.626 (bottom higher), middle varies widely (0.431-0.844). Direction is neutral as optimal eye contact appears context-dependent.'
    },
    ...
    'eye_contact_consistency': {
        ...
        'notes': 'Methodology: Data-driven. Cross-window feature (xwin_eye_contact_consistency) measuring std of eye_contact_rate across temporal windows. Production shows clear pattern: top performers avg 0.141 (consistent) vs bottom 0.225 (varied). Lower variance = more consistent eye contact throughout video.'
    },
    ...
    'gaze_variance': {
        ...
        'notes': 'Methodology: Data-driven (quartile analysis across 200+ videos). Measures gaze stability within single window (MediaPipe tracking). Range: 0.0-0.154. Many videos show 0.0 (no face detected or static scenes). Among face-present videos, top performers typically 0.001-0.010. Production: closing top=0.007 vs bottom=0.024. Lower variance = more focused/stable gaze.'
    },
