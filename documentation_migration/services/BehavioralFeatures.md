...
| dominant_emotion_id | Emotion | FEAT | expression_timeline | Window-level | Categorical (1-8) | High | Shows emotional hook/CTA | High | No | 1=joy, 2=sadness, 3=anger, 4=fear, 5=disgust, 6=surprise, 7=neutral, 8=no_person. Ties: first wins | One-hot encoding (8 binary) | Simple | One-hot encoding (8 binary) | Simple | O(n) |
